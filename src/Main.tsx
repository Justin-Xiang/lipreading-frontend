...
//============================================================================================
			let res=fetch(`http://region-11.autodl.com:14399/${window.history.state.usr.usr}/video`, {
				method: 'POST',
				body: formData,
      ...
      .then((res) => {
        ...
        console.log(res)
          ...
          // let data_decode=Base64.decode(data)
          //
          //
          // let buffer=new ArrayBuffer(data_decode)
          // console.log(buffer)
          // 循环遍历产生Blob
          //
          // let data_decode=window.atob(data)
          // console.log(data_decode)
          // console.log(typeof(data_decode))
          // const dataLength=data_decode.length;
          // console.log(`编码长度:${dataLength}`)
          // const uInt8Array = new Uint8Array(dataLength);
          // for (let i=0;i<dataLength;i++){
          //   uInt8Array[i] = data_decode.charCodeAt(i);
          // }
          // console.log(`ArrayType:${typeof(uInt8Array)}`)
    //     res.json().then((data)=>{
    //         console.log(data)
    // //         let Base64 = require('js-base64').Base64;
    // //         let byteString=Base64.decode(data);
    ...
    // // }
    // //
    // //       let blob=new Blob([ab],{type:'video/'})
    // //       console.log(blob)
		// // 			let url = URL.createObjectURL(blob);
		// // 			// let url=URL.createObjectURL(data_decode)
		// // 			// const url="data:video/webm;base64"+data
		// // 			console.log(url);
    //       let url='data:video/webm;base64,'+data
    //       setSrc(url)
    //       console.log(url);
    //
    //
    ...
    //       linkElement.setAttribute('downLoad','test1')//
    //       linkElement.click()
		// 			setSrc(url);
    //
    //       // let Base64 = require('js-base64').Base64;
    ...
    // })
        ...
        // res.json().then((data)=>{console.log(data)})
            ...
            console.log(decodeURIComponent(v.split("'").pop()!).split(
              '.'
            )[0])
					}
        });
...
<body>
    ...
    <div className="header">
        ...
        <div className="logo_Main header_item"><img src={logo} style={{width:"200px",height:"100px"}}/></div>

        <div className="header_item" id="snow">
            <div className="select_video">请选择视频：</div>
            <div className="list">
                <select name="video" style={{width:'400px', fontSize:'20px'}}  onChange={(e) => {setvalue(e.target.value);}}>
                {range(0, 100).map((i) => (
        ...
        <div className="info header_item"><p >欢迎，{window.history.state.usr.usr}！</p><button><Link to='/'>退出</Link></button></div>
    </div>
    ...
    <div className="content wrapper">
        ...
        <div className="middle">
            ...
            <div className="all_video">
                <video controls autoPlay ref={video} width="480" height="360" >
            ...
            <div className="lip_video">
                <video controls autoPlay src={src}  width="360" height="360" >

                </video>

                <video controls src={process.env.PUBLIC_URL +`/lip-area/${txt[parseInt(value) - 1] || txt[0]}.webm`} width="360" height="360" >
            ...
            <div className="result">
                <div className="result_1">
                    <div className="label"><p>正确文本</p></div>
                    <div className="wenbenkuang">{txt[parseInt(value) - 1] || '请选择文件'}</div>
                </div>
                <div className="result_2">
                    <div className="label"><p>识别结果</p></div>
        ...
        <div className="left">
            ...
            <div className="left_item">
                <button className="save" style={{height:'80px', width:'80px'}} onClick={()=>{setdload(true);}}>下载视频</button>
            </div>

            <div className="left_item">
                <button className="begin" style={{height:'80px', width:'80px'}} onClick={()=>{seton(true);}}>开始录制</button>
            </div>

            <div className="left_item">
                <button className="end" style={{height:'80px', width:'80px'}} onClick={()=>{seton(false);}}>结束录制</button>
            </div>
        </div>
        ...
        <div className="right">
            ...
            <div className="right_item">
                <button className="shouce" style={{height:'80px', width:'40px'}}>使用手册</button>
            </div>

            <div className="right_item">
                <button className="fankui" style={{height:'80px', width:'40px'}}>反馈</button>
            </div>
        </div>
    </div>
